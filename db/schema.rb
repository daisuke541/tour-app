...
ActiveRecord::Schema.define(version: 20200918082638) do
  ...
  create_table "favorite_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_favorite_relationships_on_post_id"
    t.index ["user_id", "post_id"], name: "index_favorite_relationships_on_user_id_and_post_id", unique: true
